...
namespace exercise2.DomainServices
{
    public class PostService
    {
        ...
        public static List<Post> GetPosts(string url)
        {
            ...
            try
            {
                var webProxy = new WebProxy(SettingsService.Address)
                {
                    Credentials = new NetworkCredential(SettingsService.Login, SettingsService.Password)
                };
                string feedString;
